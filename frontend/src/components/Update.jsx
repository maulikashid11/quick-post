...
const Update = () => {
    ...
    return (
        <form onSubmit={handleSubmit} className='w-[80%] mx-auto'>
            <h1 className='pt-10 font-bold text-xl'>Update Profile</h1>
            <div className='mt-5'>
            ...
            <div className='mt-5'>
                <label htmlFor="bio" className='flex items-center '>  Bio</label>
                <input onChange={handleChange} value={details.bio} className='p-2 rounded-md w-full shadow outline-none border-none' type="text" name='bio' placeholder='Bio' />
            </div>
            <div className='mt-5'>
            ...
            <button className='bg-blue-500 cursor-pointer text-white my-3 rounded-md p-2'>Update</button>
